...
function createTable()
{
  ...
  db.transaction(function(tx){
    tx.executeSql('CREATE TABLE IF NOT EXISTS Canteen (empId,location,vendorName,taste,Service,Hygine,veriety,quality,quantity,comments)',[],createSuccess,onError);
