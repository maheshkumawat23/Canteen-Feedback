 ...
 $scope.rating={};
  ...
  $scope.showAlert = function() {
    ...
    db.transaction(function (tx) {
        tx.executeSql('INSERT INTO Canteen(empId,location,vendorName,taste,Service,Hygine,veriety,quality,quantity,comments) VALUES (?,?,?,?,?,?,?,?,?,?)',[localStorage.getItem("username"),localStorage.getItem("location"),localStorage.getItem("vendor"),$scope.rating.taste,$scope.rating.service,$scope.rating.hygine,$scope.rating.veriety,$scope.rating.quality,$scope.rating.quantity,$scope.rating.comments], OnInsertSucess, onError);
    });
